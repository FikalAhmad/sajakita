  ...
  return (
    <article className="flex items-center gap-5 bg-white">
      ...
      <div className="basis-3/4 flex flex-col gap-3 w-full">
        ...
        <h3 className="font-semibold text-[16px] line-clamp-2 sm:line-clamp-none sm:text-lg lg:text-xl">{title}</h3>
        <p className="text-gray-600 text-sm line-clamp-2 hidden sm:block">{content}</p>
